...
--[[
	...
	gm_path					:graphicsmagick安装目录 如：'/usr/local/graphicsmagick-1.3.18/bin/gm'
	...
	remote_driver			:获取远程文件驱动，支持socket|http
	remote_channel  		:驱动配置
		socket.poll			:开启轮询（true|false）
]]
...
default_img_uri 	 = '/default/notfound.gif' 
default_uri_reg      = '_[0-9]+x[0-9]+' 
remote_driver 		 = 'socket'
remote_channel 		 = {
	['socket'] = { 
		poll = true,
		connections = {
			[1] = { host = '192.168.1.154', port = '22122', timeout = 100},
			[2] = { host = '192.168.1.125', port = '22122', timeout = 100}
		}
	},
	['http'] = { 
...
cfg = {
	{
		dir   = 'photos',
		sizes = {'50x50^','100x100>','140x140$','250x250!','300x300_','100x100','350x350'},
	},
	{	
		dir   = 'avatars',
		sizes = {'50x50^','80x80'},
